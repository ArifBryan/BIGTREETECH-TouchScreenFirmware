...
#define STATUS_FONT_COLOR       0  // Status (e.g. volume reminder, ABL probing point etc.) font color, such as: "Card inserted", "Card removed" (Default: 5)
...
#define PREHEAT_HOTEND {200,   220,    230,   170,    220,   250}      // Default: {200,   240,    230,   170,    220,   250}
 ...
 */
#define LCD_BRIGHTNESS       2  // LCD brightness level (Default: 11)
...
#define LED_P 250  // P: Intensity; NEOPIXEL (Default: 0)
...
#define HEAT_SHORT_ID   {"Tip",      "T1",      "T2",      "T3",      "T4",      "T5",      "Bed",  "Ch."}
 ...
 */
#define FAN_DISPLAY_ID {"Fan", "F1 ", "F2 ", "F3 ", "F4 ", "F5 ", "CtA", "CtI"}
