...
#define _LANGUAGE_EN_H_
    ...
    #define STRING_ROTATE_UI              "Rotate"
    #define STRING_TERMINAL_ACK           "Show ACK in Terminal"
    #define STRING_PERSISTENT_INFO        "Persistent Temp Info"
    ...
    // Navigation Buttons
    #define STRING_PAGE_UP                "Back"
    #define STRING_PAGE_DOWN              "Next"
    #define STRING_UP                     "Up"
    ...
    #define STRING_EMERGENCYSTOP          "E-STOP"
    ...
    #define STRING_BUSY                   "Processing, please wait..."
    ...
    #define STRING_TOUCHSCREEN_ADJUST     "Calibrate"
    ...
    #define STRING_BABYSTEP               "Z Offset"
